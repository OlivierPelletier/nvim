...
vim.keymap.set("n", "<leader>aa", function() SidekickCli.toggle({ name = "opencode", focus = true }) end, { desc = "Sidekick Toggle OpenCode" })
vim.keymap.set("n", "<leader>ac", function() SidekickCli.toggle({ name = "claude", focus = true }) end, { desc = "Sidekick Toggle Claude Code" })
