...
local languageTreeSitters = {
  ...
  "gowork", "graphql", "groovy", "hcl", "html", "java", "javascript", "jsdoc",
  "json", "lua", "luadoc", "luap", "make", "markdown", "markdown_inline",
  "mermaid", "printf", "properties", "python", "query", "regex",
  "requirements", "ron", "rust", "scss", "sql", "terraform", "tmux", "toml",
...
vim.keymap.set("i", "<C-z>", "<cmd>noh<CR>", { desc = "Remove Search Highlights" })
...
vim.keymap.set("n", "<M-k>", "kgJ", { noremap = true, silent = true })
...
vim.keymap.set("n", "<leader>N", function() Snacks.picker.diagnostics() end, { desc = "Diagnostics" })
...
vim.keymap.set({ "n", "v", "x" }, "<C-z>", "<cmd>noh<CR>", { desc = "Remove Search Highlights" })
